                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Add Company Information</h5>
                                                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                                </div>
                                                <form class="needs-validation" method="post" action="{{'companies'}}" autocomplete="off">
                                                   ...
                                                   @csrf
                                                        <div class="form">
                                                            ...
                                                            <div class="form-group mb-0">
                                                                <label for="validationCustom02" class="mb-1">Company Details :</label>
                                                                <input name="details" class="form-control" id="validationCustom02" type="text">
                                                            </div>
                                                        </div>
