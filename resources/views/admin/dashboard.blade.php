                                    ...
                                    <table class="table table-bordernone mb-0">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('adminFrontEnd')}}/images/dashboard/user2.jpg" alt="" data-original-title="" title="">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('adminFrontEnd')}}/images/dashboard/user1.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('adminFrontEnd')}}/images/dashboard/man.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('adminFrontEnd')}}/images/dashboard/user.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('adminFrontEnd')}}/images/dashboard/designer.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="{{asset('adminFrontEnd')}}/css/icofont.css">

    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="{{asset('adminFrontEnd')}}/css/prism.css">

    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="{{asset('adminFrontEnd')}}/css/chartist.css">
...
@section('script')
    ...
    <!--chartist js-->
    <script src="{{asset('adminFrontEnd')}}/js/chart/chartist/chartist.js"></script>

    <!--chartjs js-->
    <script src="{{asset('adminFrontEnd')}}/js/chart/chartjs/chart.min.js"></script>

    <!-- lazyload js-->
    <script src="{{asset('adminFrontEnd')}}/js/lazysizes.min.js"></script>

    <!--copycode js-->
    <script src="{{asset('adminFrontEnd')}}/js/prism/prism.min.js"></script>
    <script src="{{asset('adminFrontEnd')}}/js/clipboard/clipboard.min.js"></script>
    <script src="{{asset('adminFrontEnd')}}/js/custom-card/custom-card.js"></script>

    <!--counter js-->
    <script src="{{asset('adminFrontEnd')}}/js/counter/jquery.waypoints.min.js"></script>
    <script src="{{asset('adminFrontEnd')}}/js/counter/jquery.counterup.min.js"></script>
    <script src="{{asset('adminFrontEnd')}}/js/counter/counter-custom.js"></script>

    <!--peity chart js-->
    <script src="{{asset('adminFrontEnd')}}/js/chart/peity-chart/peity.jquery.js"></script>

    <!--sparkline chart js-->
    <script src="{{asset('adminFrontEnd')}}/js/chart/sparkline/sparkline.js"></script>

    <!--dashboard custom js-->
    <script src="{{asset('adminFrontEnd')}}/js/dashboard/default.js"></script>

    <!--right sidebar js-->
    <script src="{{asset('adminFrontEnd')}}/js/chat-menu.js"></script>

    <!--height equal js-->
    <script src="{{asset('adminFrontEnd')}}/js/height-equal.js"></script>
