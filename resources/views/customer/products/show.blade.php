            ...
            <div class="row">
                <div class="col-lg-9 col-sm-12 col-xs-12">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="filter-main-btn mb-2"><span class="filter-btn">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="product-slick">
                                    <div><img src="{{asset('images/'.$product->image)}}" alt="" class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                                    
                                </div>
                                <div class="row">
                                    <div class="col-12 p-0">
                                        <div class="slider-nav">
                                            <div><img src="{{asset('images/'.$product->image)}}" alt="" class="img-fluid blur-up lazyload"></div>
                            ...
                            <div class="col-lg-6 rtl-text">
                                <div class="product-right">
                                    ...
                                    <div class="product-description border-product">
                                        <h6 class="product-title size-text">Comany Name :<a href="#">{{$product->company->name}}</a></h6>
                                        <h6 class="product-title size-text">Category type :<a href="#">{{$product->category->name}}</a></h6>
                                    ...
                                    <div class="border-product">
                                        <h6 class="product-title">Posted Time</h6>
                                        <div class="timer">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg addtocart">
                                ...
                                <div class="media">
                                    <a href="#">
                                        <img class="img-fluid blur-up lazyload pro-img" src="{{asset('frontEnd')}}/images/fashion/product/43.jpg" alt="">
                                    </a>
                                    <div class="media-body align-self-center text-center">
                                        ...
                                        <div class="upsell_payment">
                                            <img src="{{asset('frontEnd')}}/images/payment_cart.png" class="img-fluid blur-up lazyload" alt="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row" id="upsell_product">
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="#">
                                                        <img src="{{asset('frontEnd')}}/images/fashion/product/1.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="#">
                                                        <img src="{{asset('frontEnd')}}/images/fashion/product/34.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                                    <h6><a href="#"><span>cotton top</span></a></h6>
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="#">
                                                        <img src="{{asset('frontEnd')}}/images/fashion/product/13.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                                    <h6><a href="#"><span>cotton top</span></a></h6>
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="#">
                                                        <img src="{{asset('frontEnd')}}/images/fashion/product/19.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                                    <h6><a href="#"><span>cotton top</span></a></h6>
