    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home  text-center">
                <img src="{{asset('frontEnd')}}/images/home-banner/4.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <h4>welcome to Pharmacy Shop</h4>
        ...
        <div>
            <div class="home text-center">
                <img src="{{asset('frontEnd')}}/images/home-banner/3.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
